all: pages challenge_slides.html capstone_soln/capstone_soln.html DC_day2intro.html
...
DC_day2intro.html: DC_day2intro.Rmd no_total_slides.css
	R -e "rmarkdown::render('$<')"

motivation.html: motivation.md
	pandoc -o $@ $^

pages: motivation.html 01-intro-to-R.html 02-dplyr.html 03-ggplot2.html 04-rmarkdown.html capstone.html
